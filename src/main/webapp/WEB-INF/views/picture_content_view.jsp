		...
		<h2 class="mb-4">글 내용 보기</h2>
			...
			<table class="table table-bordered" style="max-width: 500px;">
				...
				<tr>
					<th scope="row">이미지</th>
					<td>
						<img src="${pageContext.request.contextPath}/display2?fileName=${pcontent_view.filename}">
					</td>
				</tr>
				<tr>
					<th scope="row">내용</th>
				...
				<tr>
					<td colspan="2">
					<input type="submit" value="수정하기" formaction="picture_modify?ppageNum=${pageMaker.ppageNum}&pamount=${pageMaker.pamount}&pid=${pageMaker.pid}">
						&nbsp;&nbsp;<input type="submit" value="목록보기" formaction="picture_list"> 
				</tr>
			</table>
			</form>
			<!-- 댓글 기능 -->
