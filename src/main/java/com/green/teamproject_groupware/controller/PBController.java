...
public class PBController {
	...
	public String pwrite(@RequestParam HashMap<String, String> param, @RequestParam("uploadFile") MultipartFile uploadFile) {
	    // 파일 업로드 처리
	...
	public String pmodify(@RequestParam HashMap<String, String> param, @ModelAttribute("pcri") PBCriteria pcri, @RequestParam("uploadFile") MultipartFile uploadFile, RedirectAttributes rttr) {
	    ...
	    return "redirect:picture_content_view?ppageNum=" +pcri.getPpageNum() + "&pamount=" + pcri.getPamount() + "&pid=" + picturedto.getPid()  + " ";
	}
